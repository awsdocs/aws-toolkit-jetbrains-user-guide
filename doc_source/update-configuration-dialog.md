# Update Configuration Dialog<a name="update-configuration-dialog"></a>

The **Update Configuration** dialog in the AWS Toolkit for JetBrains displays whenever you [change \(update\) the configuration for an AWS Lambda function](key-tasks.md#key-tasks-lambda-update)\.

![\[The Update Configuration dialog\]](http://docs.aws.amazon.com/toolkit-for-jetbrains/latest/userguide/)

The **Update Configuration** dialog contains the following items\.
